...
class Recorder extends Component {
    ...
    async upload() {
        ...
        TweenLite.to('#outer-upload', 3, {rotation:360, transformOrigin: 'center center'});
    ...
    render() {
        ...
        const { recording, recorded, playnow, playended, timeleft, uploaded } = this.state;
        ...
        return (
            <div>
                ...
                <p id="button" hidden={!recording || uploaded}>
                    <br />
                    <a
                    className="yellow"
                    onClick={() => { this.reset(); }}>
